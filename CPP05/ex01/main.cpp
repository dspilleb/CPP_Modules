...
/*   Updated: 2024/03/02 16:16:15 by dspilleb         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    {
        ...
        try
        {
            Form Dan = Form("ConstructorThrow", false, 0, 1);
        }
...

    {
        ...
        try
        {
            Form Dan = Form("ConstructorThrow", false, 1, 151);
        }
        catch(const std::exception& e)
        {
            std::cerr << e.what() << std::endl;
    ...
    }
    {
        ...
        Form Bocal = Form("BocalReview", false, 10, 10);
